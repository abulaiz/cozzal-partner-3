...
var _URL = {};
_URL['index'] = $("#url-api-apartments").text();
_URL['store'] = $("#url-api-apartments-store").text();
_URL['update'] = $("#url-api-apartments-update").text();
_URL['destroy'] = $("#url-api-apartments-destroy").text();
...
var modal_edit = new Vue({
	...
	methods : {
		setData : function(id, name, address){
			this.id = id;
			this.name = name;
