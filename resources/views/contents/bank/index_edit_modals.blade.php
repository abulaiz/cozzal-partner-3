<div class="modal-dialog">
    <div class="modal-content" id="edit-modal">
        <div class="modal-header bg-primary">
            <h4 class="modal-title text-white" >Edit Bank</h4>
            <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="Bank Name" v-model="name"/>
            </div>
            <div class="form-group">
                <label>Code</label>
                <input type="text" placeholder="Bank Code" class="form-control" v-model="code"/>
            </div>
        </div>
